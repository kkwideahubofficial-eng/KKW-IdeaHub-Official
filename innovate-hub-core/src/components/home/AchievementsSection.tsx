      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-slate-50 rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden mb-10 max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 items-stretch">
            ...
            <div className="md:col-span-5 relative aspect-video md:aspect-auto min-h-[200px] bg-slate-950">
              <img 
                ...
                loading="lazy"
              />
              <div className="absolute top-3 left-3 inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-blue-600 text-white text-[10px] font-bold shadow-md">
        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {stories.map((story) => (
              ...
              >
                {/* Photo */}
                <div className="relative aspect-[16/9] overflow-hidden bg-slate-100 border-b">
                  <img 
